<div align="center">
  ...
  <h3 align="center">Next.js 14 AI Prompt Sharing Web Application</h3>
</div>
...
- **MongoDB** - A NoSQL database used for storing AI prompts.
- **NextAuth** - Authentication for Next.js apps with multiple login providers.
...
```bash
git clone https://github.com/eunini/CreativeCue.git
